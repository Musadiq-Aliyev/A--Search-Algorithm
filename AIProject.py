...
def printfunction():
    ...
    elif Inputforfirstregion=="Ismayilli" and Inputforlastregion == "Baku":
        umumi_cost = graph.Astarfunksiyasi(nodeIsmayilli, nodeBaku) # executes the algorithm
    elif Inputforfirstregion=="Astara" and Inputforlastregion == "Masalli":
        umumi_cost = graph.Astarfunksiyasi(nodeAstara, nodeMasalli) # executes the algorithm
    elif Inputforfirstregion=="Shamaxi" and Inputforlastregion == "Baku":
        umumi_cost = graph.Astarfunksiyasi(nodeShamaxi, nodeBaku) # executes the algorithm
    elif Inputforfirstregion=="Salyan" and Inputforlastregion == "Neftcala":
        umumi_cost = graph.Astarfunksiyasi(nodeSalyan, nodeNeftchala) # executes the algorithm
    elif Inputforfirstregion=="Goycay" and Inputforlastregion == "Baku":
        umumi_cost = graph.Astarfunksiyasi(nodeGoychay, nodeBaku) # executes the algorithm
